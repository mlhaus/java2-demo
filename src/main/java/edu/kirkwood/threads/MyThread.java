...
public class MyThread implements Runnable {
    ...
    public void run() {
        ...
        // Use the synchronized block when calling a method that multiple threads
        // access simultaneously. Or add the synchronized keyword directly to the method signature.
        synchronized(sa) {
